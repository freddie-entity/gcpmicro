...
REQUEST_INPROGRESS = Gauge('emailservice_python_app_requests_inprogress','number of application requests in progress')
REQUEST_LAST_SERVED = Gauge('emailservice_python_app_last_served', 'Time the application was last served.')
